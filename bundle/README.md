...
```powershell
# Full v0.17.0 operator bundle (downloads the pinned pwsh 7.4 LTS patch, the CISA KEV catalog, and builds the scanner venv):
pwsh ./bundle/build-bundle.ps1 -Version 0.17.0 -PwshVersion 7.4.20 -Zip

# Using a pre-downloaded portable pwsh zip instead of fetching it:
pwsh ./bundle/build-bundle.ps1 -Version 0.17.0 -PwshVersion 7.4.20 -PwshZip C:\downloads\PowerShell-7.4.20-win-x64.zip -Zip
