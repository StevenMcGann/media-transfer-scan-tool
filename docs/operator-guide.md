...
select offline mode. In v0.15.0 there is no vendored OSV advisory database, so
...
v0.15.0 recursively classifies and dispatches ordinary members of ZIP and tar
