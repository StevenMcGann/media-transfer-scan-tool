...
pwsh ./bundle/build-bundle.ps1 -Version 0.15.0 -PwshVersion 7.4.19 -Zip

# Using a pre-downloaded portable pwsh zip instead of fetching it:
pwsh ./bundle/build-bundle.ps1 -Version 0.15.0 -PwshVersion 7.4.19 -PwshZip C:\downloads\PowerShell-7.4.19-win-x64.zip -Zip
