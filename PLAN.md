...
- **Current package release:** v0.17.0
...
| v0.16.0 | CISA KEV enrichment of OSV findings, with a vendored catalog and explicit KEV coverage gaps |
| v0.17.0 | Defender false-positive fix: token-digest PowerShell indicator matching with bounded, fail-closed scanning |
